    ...
    <div class="wrapper">
            ...
            <ul class="navbar-nav align-items-center">
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3 flex-grow-1">
                          <h6 class="mb-0 dropdown-msg-user">Althea Cabardo <span
                              class="msg-time float-end text-secondary">7
                              m</span></h6>
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3 flex-grow-1">
                          <h6 class="mb-0 dropdown-msg-user">Peter Costanzo <span
                              class="msg-time float-end text-secondary">3
                              h</span></h6>
              ...
              <li class="nav-item dropdown dropdown-large">
                ...
                <div class="dropdown-menu dropdown-menu-end p-0">
                  ...
                  <div class="p-2">
                    ...
                    <a class="dropdown-item" href="#">
                      <div class="text-center text-dark"> View All Notifications</div>
                    </a>
                  </div>
                </div>
              </li>
              <li class="nav-item dropdown dropdown-user-setting">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                  ...
                  <li>
                    <a class="dropdown-item" href="./pages/JobPostings.html">
                      <div class="d-flex align-items-center">
                        <div class=""><i class="bi bi-grid-fill"></i></div>
                        <div class="ms-3"><span>Job Postings</span></div>
                      </div>
                    </a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="./pages/Inbox.html">
                      <div class="d-flex align-items-center">
                        <div class=""><i class="bi bi-droplet-fill"></i></div>
                        <div class="ms-3"><span>Inbox</span></div>
                      </div>
                    </a>
                  </li>
                  <li>
      ...
      <aside class="sidebar-wrapper" data-simplebar="true">
        <div class="sidebar-header">
          <div>
            <a href="./Index.html"><img src="../assets/images/launcher-black-3.jpg" class="logo-icon" alt="logo icon"></a>
  
          </div>
          <div>
            <h4 class="logo-text">Launcher</h4>
          </div>
        ...
        <ul class="metismenu" id="menu">
          ...
          <li>
            <a href="jobs">
              ...
              <div class="menu-title">Job Postings</div>
            </a>
